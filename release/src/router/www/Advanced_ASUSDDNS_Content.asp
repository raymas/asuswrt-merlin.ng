			...
			<tr>
				...
				<td>
					<select name="ddns_server_x"class="input_option" onchange="change_ddns_setting(this.value); change_cert_method();">
						...
						<option value="WWW.CLOUDFLARE.COM" <% nvram_match("ddns_server_x", "WWW.CLOUDFLARE.COM","selected"); %>>FREEDNS.AFRAID.ORG</option>
						<option value="WWW.YANDEX.RU" <% nvram_match("ddns_server_x", "WWW.YANDEX.RU","selected"); %>>FREEDNS.AFRAID.ORG</option>
